      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between gap-20 mb-16">
          ...
          <div className="flex flex-col gap-8">
            <span className="text-[10px] uppercase tracking-widest text-white/40 block font-mono">Headquarters</span>
            <div className="text-[10px] text-white/40 font-mono leading-relaxed uppercase">
              Three Pillars Foundation<br />
              400 Cervantes Rd<br />
              Portola Valley, CA<br /><br />
              408-375-3676<br />
