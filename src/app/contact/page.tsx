...
export default function ContactPage() {
    return (
        <div className="w-full bg-white text-black" id="contact-page">
            {/* Hero Section */}
            <section
                className="relative h-screen w-full flex flex-col justify-end overflow-hidden px-6 md:px-12 bg-black"
                id="contact-hero"
            >
                ...
                <div className="max-w-7xl mx-auto w-full pb-32 relative z-20">
                    <HeroTitle subtitle="GET IN TOUCH">
                        Let's Talk
                    </HeroTitle>
                </div>
            </section>
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
                            <div className="space-y-2">
                                <label className="text-[10px] uppercase tracking-[0.3em] font-mono text-black/60">Full Name *</label>
                                <input 
                                    type="text" 
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] uppercase tracking-[0.3em] font-mono text-black/60">Email *</label>
                                <input 
                                    type="email" 
                                    className="w-full border-b border-black/10 py-4 focus:border-black transition-colors outline-none font-sans text-lg" 
                            ...
                            <div className="space-y-8">
                                <label className="text-[10px] uppercase tracking-[0.3em] font-mono text-black/60 block">Membership & Interest</label>
                            ...
                            <div className="space-y-2 pt-4">
                                <label className="text-[10px] uppercase tracking-[0.3em] font-mono text-black/60">Message *</label>
                                <textarea 
                                    rows={4}
                            ...
                            <div className="flex flex-col gap-8 pt-4">
                                <div className="flex flex-col gap-4">
                                    <button 
                                        className="bg-black text-white px-12 py-5 text-[11px] uppercase tracking-[0.3em] font-mono hover:bg-brand-accent transition-all flex items-center gap-4 group rounded-sm justify-center md:justify-start w-full md:w-fit"
                                    >
                                ...
                                <div className="mt-16 pt-16 border-t border-black/10">
                                    <div className="flex items-start gap-3 text-black/40">
                                        <CheckCircle2 size={14} className="mt-0.5 opacity-50" />
